...
namespace MT.LQQ.Utilitys.Helpers
{
    ...
    public static class ReflectionHelper
    {
        ...
        public  static void SetPropertyValue(PropertyInfo property, object item, object value)
        {
            ...
            if (propertyType != valueType)
            {
                ...
                {
                    value = valueType == typeof (string) ? Enum.Parse(propertyType, (string) value, true)
                        : Enum.ToObject(propertyType, value);
                }
                else if (!IsBasicClrType(propertyType))
                    return;
