					...
					if (propertyType != field.Type)
					{
					    if (propertyType.IsEnum)
					    {
					        if (field.Type == typeof (string))
					            value = System.Enum.Parse(propertyType, (string) value, true);
					        else if (field.Type == typeof (decimal))
					        {
					            value = System.Enum.ToObject(propertyType, (int) (decimal) value);
					        }
					        else
					        {
					            value = System.Enum.ToObject(propertyType, value);
					        }
					    }
